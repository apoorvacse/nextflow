          ...
          function(ffprobe, cb) {
            ...
            self._getFfmpegPath(function(err, ffmpeg) {
              if (err) {
                ...
                var ffprobe2 = path2.join(path2.dirname(ffmpeg), name);
...
async function uploadToTransloadit(filePath, type) {
  ...
  const Transloadit = "default" in transloaditMod ? transloaditMod.default : transloaditMod;
  ...
  const result = results ? Object.values(results)[0]?.[0] : void 0;
...
//# sourceMappingURL=chunk-XDZ737ZI.mjs.map
